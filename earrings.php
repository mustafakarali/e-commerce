...
<head>
	...
	<title>Nora's Jewelry | Earrings</title>
		...
		//alert( document.getElementById('s1').value);
			...
			{
				case "All":
				window.location="earrings.php?type=All";
				break;

				case "South Sea Pearl":
				window.location="earrings.php?type=South Sea Pearl";
				break;

				case "Fresh Water Pearl":
				window.location="earrings.php?type=Fresh Water Pearl";
				break;
			}// end of switch 
		}
		////////////////// 
		...
		// ON selection of section this function will work
			...
			{
				case "a":
					window.location = "earrings.php?" + range + "&range=a";
				break;
				
				case "b":
					window.location = "earrings.php?" + range + "&range=b";
				break;
				
				case "c":
					window.location = "earrings.php?" + range + "&range=c";
				break;
				
				case "d":
					window.location = "earrings.php?" + range + "&range=d";
				break;
				
				case "e":
					window.location = "earrings.php?" + range + "&range=e";
				break;
				
				case "f":
					window.location = "earrings.php?" + range + "&range=f";
				break;
					...
					<?php 
						if(isset($_REQUEST['type']) && $_REQUEST['type']!='All') {
							...
							if(isset($_REQUEST['range']) && $_REQUEST['range']!='a') {
								if($_REQUEST['range']=='b') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where' AND price >= 1 and price <= 1000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='c') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where' AND price >= 1001 and price <= 2500") or die(mysql_error());
								}
								else if($_REQUEST['range']=='d') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where' AND price >= 2501 and price <= 5000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='e') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where' AND price >= 5001 and price <= 10000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='f') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where' AND price >= 10001 and price <= 50000") or die(mysql_error());
								}
							}
							else {
								$sql = mysql_query("SELECT * FROM tbl_earrings WHERE type='$where'") or die(mysql_error());
							}
						}
						else {
							if(isset($_REQUEST['range']) && $_REQUEST['range']!='a') {
								if($_REQUEST['range']=='b') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE price >= 1 and price <= 1000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='c') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE price >= 1001 and price <= 2500") or die(mysql_error());
								}
								else if($_REQUEST['range']=='d') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE price >= 2501 and price <= 5000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='e') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE price >= 5001 and price <= 10000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='f') {
									$sql = mysql_query("SELECT * FROM tbl_earrings WHERE price >= 10001 and price <= 50000") or die(mysql_error());
								}
							}
							else {
								$sql = mysql_query("SELECT * FROM tbl_earrings") or die(mysql_error());
							}
						}
