...
$db_name = "db_tago"; //database name

// PayPal settings
$paypal_email = 'jewelries_noratago@gmail.com';
...
$item_name = "Nora's Jewelries";
$item_amount = $_SESSION['subTotal'];
//$item_amount = 5.00;
	...
	if (!$fp) {
		...
		while (!feof($fp)) {
			...
			if (strcmp($res, "VERIFIED") == 0) {
				...
				@mail("jewelry.noratago@gmail.com", "PAYPAL DEBUGGING", "Verified Response<br />data = <pre>".print_r($post, true)."</pre>");
