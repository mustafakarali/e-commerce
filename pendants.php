...
<head>
	...
	<title>Nora's Jewelry | Pendants</title>
	...
	<script language="javascript">
		...
		//alert( document.getElementById('s1').value);
			...
			{
				case "All":
				window.location="pendants.php?type=All";
				break;

				case "South Sea Pearl":
				window.location="pendants.php?type=South Sea Pearl";
				break;

				case "Fresh Water Pearl":
				window.location="pendants.php?type=Fresh Water Pearl";
				break;
			}// end of switch 
		}
		////////////////// 
		...
		// ON selection of section this function will work
			...
			{
				case "a":
					window.location = "pendants.php?" + range + "&range=a";
				break;
				
				case "b":
					window.location = "pendants.php?" + range + "&range=b";
				break;
				
				case "c":
					window.location = "pendants.php?" + range + "&range=c";
				break;
				
				case "d":
					window.location = "pendants.php?" + range + "&range=d";
				break;
				
				case "e":
					window.location = "pendants.php?" + range + "&range=e";
				break;
				
				case "f":
					window.location = "pendants.php?" + range + "&range=f";
				break;
					...
					<?php 
						if(isset($_REQUEST['type']) && $_REQUEST['type']!='All') {
							...
							if(isset($_REQUEST['range']) && $_REQUEST['range']!='a') {
								if($_REQUEST['range']=='b') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where' AND price >= 1 and price <= 1000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='c') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where' AND price >= 1001 and price <= 2500") or die(mysql_error());
								}
								else if($_REQUEST['range']=='d') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where' AND price >= 2501 and price <= 5000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='e') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where' AND price >= 5001 and price <= 10000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='f') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where' AND price >= 10001 and price <= 50000") or die(mysql_error());
								}
							}
							else {
								$sql = mysql_query("SELECT * FROM tbl_pendant WHERE type='$where'") or die(mysql_error());
							}
						}
						else {
							if(isset($_REQUEST['range']) && $_REQUEST['range']!='a') {
								if($_REQUEST['range']=='b') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE price >= 1 and price <= 1000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='c') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE price >= 1001 and price <= 2500") or die(mysql_error());
								}
								else if($_REQUEST['range']=='d') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE price >= 2501 and price <= 5000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='e') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE price >= 5001 and price <= 10000") or die(mysql_error());
								}
								else if($_REQUEST['range']=='f') {
									$sql = mysql_query("SELECT * FROM tbl_pendant WHERE price >= 10001 and price <= 50000") or die(mysql_error());
								}
							}
							else {
								$sql = mysql_query("SELECT * FROM tbl_pendant") or die(mysql_error());
							}
						}
