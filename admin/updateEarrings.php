<?php
	...
	$uploadDir = '../products/earrings/'; 
	
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_earrings WHERE earrings_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE tbl_earrings SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE earrings_no='$id'")
								or die (mysql_error());
