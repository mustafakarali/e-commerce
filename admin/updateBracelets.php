<?php
	...
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_bracelets WHERE bracelets_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE tbl_bracelets SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE bracelets_no='$id'")
								or die (mysql_error());
