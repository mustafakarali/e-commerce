<?php
	...
	$uploadDir = '../products/set/'; 
	
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_set WHERE set_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE tbl_set SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE set_no='$id'")
								or die (mysql_error());
