<?php
	...
	$uploadDir = '../products/pendant/'; 
	
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_pendant WHERE pendant_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE tbl_pendant SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE pendant_no='$id'")
								or die (mysql_error());
