<?php
	...
	$uploadDir = '../products/necklace/'; 
	
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_necklace WHERE necklace_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$query3 = "SELECT * FROM tbl_bracelets ORDER BY bracelets_no DESC LIMIT 0, 1";
		$result = mysql_query($query3);*/
		
		$sql = mysql_query("UPDATE tbl_necklace SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE necklace_no='$id'")
								or die (mysql_error());
...
<html>
    ...
    <head>
        <title>Administrator | Update Item</title>
        <!-- Bootstrap -->
	 ...
	 ?>
					...
					?>">
										 ...
										 <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea" name="desc" placeholder="Enter text ..." style="width: 570px; height: 200px"><?php echo $desc ?></textarea>
                                          </div>
                                        </div>
                                        <div class="control-group">
