...
$desc = $_POST['desc'];
		...
		$query = "INSERT INTO tbl_set (name,path,type,price,description,stock) 
		VALUES ('$item','$fileName','$type','$price','$desc','$stock')";
		mysql_query($query) or die(mysql_error());
		
		$select = "SELECT * FROM tbl_set ORDER BY set_no DESC LIMIT 0, 1";
		...
		$item1 = "INSERT INTO tbl_item(category,id) VALUES ('set','$num')";
