<?php
	...
	$uploadDir = '../products/rings/'; 
	
	$id = $_REQUEST['myVar'];
	$myQuery = mysql_query("SELECT * FROM tbl_rings WHERE rings_no='$id'");
	...
	if(isset($_POST['update']))
	{
		...
		$sql = mysql_query("UPDATE tbl_rings SET name='$name',type='$type',price='$price',description='$desc',stock='$stock' WHERE rings_no='$id'")
								or die (mysql_error());
