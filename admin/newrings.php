...
$desc = $_POST['desc'];
		...
		$query = "INSERT INTO tbl_rings (name,path,type,price,description,stock) 
		VALUES ('$item','$fileName','$type','$price','$desc','$stock')";
		mysql_query($query) or die(mysql_error());
		
		$select = "SELECT * FROM tbl_rings ORDER BY rings_no DESC LIMIT 0, 1";
		...
		$item1 = "INSERT INTO tbl_item(category,id) VALUES ('rings','$num')";
